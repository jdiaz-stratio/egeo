...
export class StTagInputDemoComponent implements OnInit {
   ...
   ngOnInit(): void {
      ...
      this.reactiveForm.controls['tag-input-reactive-autocomplete'].setValue( ['ads', 'overflowwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww' ]);
