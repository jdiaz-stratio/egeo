...
export const EGEO_DEMO_MENU: EgeoDemoMenu[] = [
   ...
   { id: 'st-select-searchable', name: 'Select Searchable', path: 'select-searchable-demo', moduleLazyLoad: 'StSelectSearchableDemoModule' },
...
const routes: Routes = [
   ...
   { path: 'select-searchable-demo', loadChildren: './st-select-searchable-demo/st-select-searchable-demo.module#StSelectSearchableDemoModule' },
